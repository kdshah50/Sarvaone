...
> = {
  es: {
    ...
    heroSub: "Aparece en el directorio de AISaravanna en New Jersey de Allende — registro gratis, menú de precios fijos, cobros seguros en la app y presupuestos desde el chat.",
    ...
    whySub: "Tres razones por las que veterinarias de NJ ya están en AISaravanna.",
    ...
    menuSub: "Esta plantilla se carga al registrarte. Editas cada precio según tu clínica y zona. AISaravanna no te impone precios.",
    ...
    faq1A: "Nada. El registro es gratuito. AISaravanna cobra comisión solo cuando recibes un pago en línea — los términos se acuerdan contigo antes de cualquier cobro.",
  ...
  en: {
    ...
    heroSub: "List on AISaravanna in New Jersey de Allende — free signup, fixed-price service menu, secure in-app payments, and quotes built from chat.",
    ...
    whyTitle: "Why join?",
    whySub: "Three reasons vets in NJ are already on AISaravanna.",
    ...
    menuSub: "This template loads at signup. Edit every price for your clinic and area. AISaravanna doesn't set prices for you.",
    ...
    faq1A: "Nothing. Signup is free. AISaravanna only takes a commission when you receive an in-app payment — terms are agreed before any charge.",
...
export function generateMetadata({
  ...
  const title =
    lang === "es"
      ? "Servicios veterinarios en New Jersey de Allende | AISaravanna"
      : "Veterinary services in New Jersey de Allende | AISaravanna";
  return {
    title,
