...
/** Pre-filled starter menu for taxi / ride-hailing fixed-price trips (Middlesex County, NJ). */
  ...
  const items: ServiceMenuItem[] = [
    {
      ...
      price_mxn_cents: 3500,
    },
    {
      sku: "edison_local",
      name_es: "Edison — viaje local (solo ida)",
      name_en: "Edison local trip (one way)",
      price_mxn_cents: 2800,
    },
    {
      sku: "edison_new_brunswick",
      name_es: "Edison ↔ New Brunswick (solo ida)",
      name_en: "Edison ↔ New Brunswick (one way)",
      price_mxn_cents: 3800,
    },
    {
      sku: "ewr_airport",
      name_es: "Aeropuerto Newark (EWR) — desde Middlesex",
      name_en: "Newark Liberty (EWR) — from Middlesex",
      price_mxn_cents: 5800,
    },
    {
      sku: "jfk_airport",
      name_es: "Aeropuerto JFK — desde Middlesex",
      name_en: "JFK Airport — from Middlesex",
      price_mxn_cents: 12500,
    },
    {
      sku: "lga_airport",
      name_es: "Aeropuerto LaGuardia (LGA) — desde Middlesex",
      name_en: "LaGuardia (LGA) — from Middlesex",
      price_mxn_cents: 11500,
    },
    {
      sku: "hospital_rwj",
      name_es: "RWJ University Hospital (New Brunswick) — solo ida",
      name_en: "RWJ University Hospital (New Brunswick) — one way",
      price_mxn_cents: 3200,
    },
    {
      sku: "hospital_jfk_med",
      name_es: "JFK Medical Center (Edison) — solo ida",
      name_en: "JFK Medical Center (Edison) — one way",
      price_mxn_cents: 3000,
    },
    {
      sku: "shopping_errands",
      name_es: "Compras / mandados (local, solo ida)",
      name_en: "Shopping / errands (local, one way)",
      price_mxn_cents: 3000,
    },
    {
      sku: "round_trip_wait",
      name_es: "Ida y vuelta + 1 h de espera",
      name_en: "Round trip + 1 hr wait",
      price_mxn_cents: 8500,
    },
    {
      sku: "other_custom",
      name_es: "Otro trayecto (cotizar en chat)",
      name_en: "Other route (quote in chat)",
      price_mxn_cents: 3500,
    },
  ];
  return {
